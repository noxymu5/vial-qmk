...
[BASE] = LAYOUT(
  ...
  LT(SYMB,KC_GRV),  KC_QUOT,        LALT(KC_LSFT),  KC_LEFT,    KC_RGHT,    ALT_T(KC_APP),  KC_LGUI,          KC_LALT,      CTL_T(KC_ESC),  KC_UP,   KC_DOWN, KC_LBRC,  KC_RBRC,            TT(SYMB),
...
[SYMB] = LAYOUT(
  ...
  EE_CLR,   KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    RGB_MOD,    KC_TRNS,        RGB_TOG,    RGB_M_P,    KC_TRNS,    KC_DOT, KC_0,   KC_EQL,     KC_TRNS,
...
[MDIA] = LAYOUT(
  ...
  KC_TRNS,  KC_TRNS,    KC_TRNS,    KC_BTN1,    KC_BTN2,    KC_TRNS,    KC_TRNS,        KC_TRNS,    KC_TRNS,    KC_VOLU,    KC_VOLD,    KC_MUTE,    KC_TRNS,    KC_TRNS,
